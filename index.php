  ...
  <body data-spy="scroll" data-target="#navbar">
	   ...
	   <div class="container">
	   		...
	   		<article class="row slide-right building">
	   			...
	   			<div class="col-xs-12 col-sm-6 col-md-6">
	   				...
	   				<p>Otherwise, it gets the message across and attracts attention. If I were to improve the design now I would probably make it look less swooshy. The top left stripe seems to attract a lot of attention and there is nothing there. 
	   			</div>
	   		</article>
	   ...
	   <div class="container">
	   		...
	   		<article class="row slide-right gocubego">
	   			...
	   			<div class="col-sm-12 col-md-6">
	   				...
	   				<p>This was my favourite project to work on during my university studies. I also created a level editor to assist me in creating new levels. If you are interested <a href="http://vimeo.com/78106625" target="_blank">you can view a video of the level editor as well</a>. 
	   			</div>		   		
	   		</article>
   ...
   <div class="modal fade" id="imgModal" tabindex="-1">
    ...
    <script>
	  ...
	  ga('create', 'UA-46213013-1', 'andrew-mcgowan.com');
	  ga('send', 'pageview');
